    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="btn-group float-left">Pengurus</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="text-left mb-4">
                        <a class="btn btn-success" href="{{ route('dashboard.pengurus.create') }}" role="button">Tambah
                            Data</a>
                    </div>
                                        ...
                                        <td>
                                            <div class=" d-flex button-items">
                                                <a class="btn btn-info"
                                                    href="{{ route('dashboard.pengurus.edit', $user->id) }}"
                                                    role="button"><i class="mdi mdi-lead-pencil"></i></a>
                                                <form action="{{ route('dashboard.pengurus.destroy', $user->id) }}"
